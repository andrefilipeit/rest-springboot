...
import br.com.rest.springboot.mapper.custom.PersonMapper;
...
public class PersonService {
	...
	public PersonVOV2 createV2(PersonVOV2 personVOV2) { //getting from bodyRequest
		logger.info("PersonVOV2 created!");
		
		//Converting from VO to Person
		var person = personMapper.convertVoV2ToEntity(personVOV2);
		
		//Converting from Person to VO
		var vov2 = personMapper.convertEntityToVo(repository.save(person));
		return vov2;
	}
