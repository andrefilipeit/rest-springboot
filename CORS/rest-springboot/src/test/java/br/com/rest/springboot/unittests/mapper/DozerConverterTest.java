package br.com.rest.springboot.unittests.mapper;
...
import br.com.rest.springboot.mapper.mocks.MockPerson;
...
public class DozerConverterTest {
    ...
    public void parseEntityToVOTest() {
        ...
        assertEquals(Long.valueOf(0L), output.getPk());
    ...
    public void parseEntityListToVOListTest() {
        ...
        assertEquals(Long.valueOf(0L), outputZero.getPk());
        ...
        assertEquals(Long.valueOf(7L), outputSeven.getPk());
        ...
        assertEquals(Long.valueOf(12L), outputTwelve.getPk());
