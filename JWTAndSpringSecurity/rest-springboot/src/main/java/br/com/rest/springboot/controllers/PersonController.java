...
public class PersonController {
	...
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findAll(
		...
		Pageable pageable = PageRequest.of(page, size, Sort.by(sortDirection, "firstName")); //Sort by java attribute 
	...
	@GetMapping(value = "/findPersonByName/{firstName}",
			produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML })
	//Operation for Swagger stylization
	@Operation(summary = "Finds Person By FirstName", description = "Finds Person By FirstName",
	tags = {"People"},
	responses = {
			@ApiResponse(description = "Success", responseCode = "200",
					content = {
