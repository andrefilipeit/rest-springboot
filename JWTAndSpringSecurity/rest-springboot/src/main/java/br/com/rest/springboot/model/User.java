package br.com.rest.springboot.model;
...
public class User implements UserDetails, Serializable{
	...
	//manyToMany (Table user_permission)
	@ManyToMany(fetch = FetchType.EAGER) //https://stackoverflow.com/questions/2990799/difference-between-fetchtype-lazy-and-eager-in-java-persistence-api
	@JoinTable(name = "user_permission", joinColumns = {@JoinColumn (name = "id_user")},
		inverseJoinColumns = {@JoinColumn (name = "id_permission")} //other table column reference key
	)
	private List<Permission> permissions;
	
	public User() {} //JPA need a default constructor
